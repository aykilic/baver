                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" name="durumid" id="durumid" value="" class="form-control" >
                ...
                $.ajax({
                    ...
                    success:function (response) {
                        ...
                        $.each (response, function (veri) {
                            ...
                            var selectmenu ='<td ><div class="col-lg-12 kutupad"><div class="form-group kutupad "><input type="hidden" name="sipfissatirid[]" id="sipfissatirid'+i+'" ' +
                                ...
                                '</div><td><div class="col-md-12 kutupad"><input type="text" name="miktar[]" id="miktar'+i+'" data-inputmask="\'alias\': \'myCurrency\'" oninput="calculate('+i+')" ' +
                                'value="'+response[veri].miktar+'" autocomplete="off" class="form-control miktar" style="font-family: monospace, monospace;"></div></td><td><div class="col-lg-12 kutupad">' +
                                '<select data-toggle="dropdown" id="birim'+i+'" class="form-control birim" name="birim[]" aria-expanded="false" ><span class="caret"></span>@foreach($birim as $key => $bad)
                                    <option  value="{{ $key }}">{{ $bad }}</option>@endforeach</select></div></td><td><div class="col-md-12 kutupad"><input type="text" name="bfiyat[]" id="bfiyat'+i+'" ' +
