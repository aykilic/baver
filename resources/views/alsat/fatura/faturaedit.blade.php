                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <div class="x_content">
                                <form id="esatirler" action="{{action('faturaController@faturaeditkaydet')}}" class="form-horizontal form-label-left" name="form1" method="POST"  novalidate>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <!-- {{--textbox başlangıç--}} -->
                                                ...
                                                <div class="form-group item">
                                                    ...
                                                    <input type="hidden" name="fatnold" id="irnold" value="{{$numara}}" class="form-control" >
                                                    {{--<input type="hidden" name="sfisno" id="sfisno" value="{{$snumara}}" class="form-control" >--}}
