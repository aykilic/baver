                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <div class="x_content">
                                <form  action="{{ action('Controller@bankakaydet') }}" method="POST" >
                                    {{csrf_field()}}
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" name="bankad" id="cunvan" value="" class="form-control has-feedback-left"  autocomplate="off" aria-required="true">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <button  class="btn btn-success btn-insert btn-xs-block"   type="submit" ><i class="fa fa-plus-square"></i>Kaydet</button>
                                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped" id="banka">
                                ...
                                @foreach($banka as $post)
                                    <tr>
                                        <td > <a href="banka/edit/{{$post->baid}}">{{$post->bankad}}</a>                    </td>

                                        <td><a href="banka/edit/{{$post->baid}}" ><i class="fa fa-edit fa-2x"></i></a></td>

                                        <td><a href="banka/sil/{{$post->baid}}"  aria-label="Delete"><i class="fa fa-trash-o fa-2x" aria-hidden="true"></i></a></td>
