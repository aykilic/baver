            ...
            <div class="row">
                ...
                <div class="col-md-12 ">
                    <div class="x_panel">
                        <div class="x_title">
                            @if($makbuzturu==1)
                                <h2 class="al">{{$makbuzadi}} Fişi </h2>
                            @else
                                <h2 class="sat">{{$makbuzadi}} Fişi </h2>
                                    ...
                                    <div class="x_panel">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group has-feedback">
                                                    ...
                                                    <input type="text" name="tar" id="tarih" class="form-control has-feedback-left"   >
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                {{--<div class="radio">--}}
                                                                {{--<label >--}}
                                                                {{--<input type="radio" checked="" value="" id="optionsRadios1" name="optionsRadios"> Nakit--}}
                                                                {{--</label>--}}

                                                                {{--<label class="frightlabel">--}}
                                                                {{--<input type="radio" value="" id="optionsRadios2" name="optionsRadios"> Çek--}}
                                                                {{--</label>--}}

                                                                {{--</div>--}}
                                                                <div class="col-md-7">

                                                                    <input type="radio" name="iCheck" id="nakit" class="iradio_square-grey" checked>
                                                                    <label for="nakit" class="ll ">Nakit</label>
                                                                </div>

                                                                <div class="col-md-4 frightlabel">
                                                                    <input type="radio" name="iCheck" id="havale" class="iradio_square-grey " >
                                            ...
                                            <div class=" col-md-4 ">
                                                <div class="x_panel">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group text-center">
                                                                <label class="text-center">Banka</label>
                                                            </div> <!-- /.form-group -->
                                                        </div> <!-- /.col -->
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                            ...
                                            <div class=" col-md-4 ">
                                                <div class="x_panel">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group text-center">
                                                                <label class="text-center">Hesap</label>
                                                            </div> <!-- /.form-group -->
                                                        </div> <!-- /.col -->
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data[0].bankad == null) {
                                ...
                                // var a =new Array();
                                // $.each(data, function(index, value) {
                                //      // cosole.log(index[0],value[0])
                                //     a.push(value[0],value.bankad);
                                // });
                                //  console.log(a)
                            }
