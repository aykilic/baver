...
@section('main_container')
    ...
    <head>
        ...
        <!-- Ion.RangeSlider -->
        <link href="{{ asset('assets/vendor/normalize-css/normalize.css') }}" rel="stylesheet">
        <link href="{{ asset('assets/vendor/ion.rangeSlider/css/ion.rangeSlider.css') }}" rel="stylesheet">
        <link href="{{ asset('assets/vendor/ion.rangeSlider/css/ion.rangeSlider.skinFlat.css') }}" rel="stylesheet">
        <!-- Bootstrap Colorpicker -->
        <link href="{{ asset('assets/vendor/mjolnic-bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css') }}" rel="stylesheet">

        <link href="{{ asset('assets/vendor/cropper/dist/cropper.min.css') }}" rel="stylesheet">
                        ...
                        <div class="row">
                            <div class="col-md-9">
                                <div class="img-container">
                                    <img id="image" src="{{ asset('assets/images/cropper.jpg') }}" alt="Picture">
                                </div>
                            </div>
                            <div class="col-md-3">
    ...
    <!-- Bootstrap Colorpicker -->
    <script src="{{ asset('assets/vendor/mjolnic-bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js') }}"></script>
    <!-- jquery.inputmask -->
    <script src="{{ asset('assets/vendor/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js') }}"></script>
    <!-- jQuery Knob -->
